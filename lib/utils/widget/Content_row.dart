                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Text(
                            content.type == null ? 'not assigned' : AppFunction.getContentType(content.type),
                            maxLines: 1,
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Text(
                            content.date == null ? 'not assigned' : content.date,
                            maxLines: 1,
                            style: Theme.of(context).textTheme.display1,
                          ),
                        ],
    ...
    try {
      ...
      await dio
        ...
        setState(() {
          ...
          if (progress == '100%')Utils.showToast("Download completed\n please check download folder");
        });
      });
    } catch (e) {
      print(e);
...
//class Content_row extends StatelessWidget {
//
//  Content content;
//  var progress = "download";
//  Content_row(this.content);
//
//  Random random = Random();
//
//  @override
...
//      child: Text("download"),
//      onPressed: () {
//        content.url != null ? downloadFile(content.url) : Utils.showToast('no file found');
//      },
//    );
//
//    // set up the AlertDialog
